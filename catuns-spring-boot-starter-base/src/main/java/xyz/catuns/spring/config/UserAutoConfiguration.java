...
import xyz.catuns.spring.repository.user.UserRepository;
import xyz.catuns.spring.security.DefaultUserDetailsService;
...
public class UserAutoConfiguration {
    ...
    public DefaultUserDetailsService defaultUserDetailsService(UserRepository userRepository) {
